    ...
    private void init() {
        List<Part> parts = new ArrayList<>(
                Arrays.asList(
                    ...
                    new Part("9068709926", "Радиатор", "SA-4987", 13, "*Не родственник радио"),
